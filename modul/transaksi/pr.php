    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3 col-6">
            <div class="card card-stats shadow-sm border-start border-warning border-4">
                <div class="card-body">
                    <div class="text-muted small fw-bold">MENUNGGU (PENDING)</div>
                    <h3 class="fw-bold mb-0"><?= $count_pending ?> <small class="text-muted fs-6">Form</small></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="card card-stats shadow-sm border-start border-primary border-4">
                <div class="card-body">
                    <div class="text-muted small fw-bold">SEDANG DIPROSES</div>
                    <h3 class="fw-bold mb-0"><?= $count_proses ?> <small class="text-muted fs-6">Form</small></h3>
                </div>
            </div>
        </div>
    </div>
            ...
            <table class="table table-hover align-middle w-100" id="tablePR">
                ...
                <tbody class="small">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <span class="badge status-badge <?= $badge_color ?>"><?= $row['status_request'] ?></span>
                        </td>
                        <td class="text-center">
                            <div class="btn-group">
...
<script>
    ...
    if (pesan === 'berhasil') {
        Swal.fire({
            icon: 'success',
            title: 'BERHASIL!',
            html: `Request <b>${no_pr}</b> telah berhasil dibuat dan disimpan ke sistem.`,
