...
<head>
    ...
    <style>
        ...
        /* Layout Utama agar tidak geser */
        body, html {
            height: 100%;
            margin: 0;
            overflow: hidden; /* Hilangkan scroll utama browser */
        ...
        .sidebar { 
            ...
            height: 100vh;
            overflow-y: auto; /* Sidebar bisa scroll sendiri jika menu penuh */
            transition: 0.3s;
        }
        ...
        .sidebar::-webkit-scrollbar-track { 
            background: rgba(0,0,0,0.1); /* Background jalur scroll agak gelap */
        }
        .sidebar::-webkit-scrollbar-thumb { 
            background: rgba(255, 255, 255, 0.3); /* Warna putih transparan agar terlihat di atas biru */
            border-radius: 10px;
            border: 2px solid var(--mcp-blue); /* Memberi jarak agar terlihat ramping */
        }
        .sidebar::-webkit-scrollbar-thumb:hover { 
            background: rgba(255, 255, 255, 0.5); /* Lebih terang saat kursor di atasnya */
        }

        /* Custom Scrollbar untuk Area Konten Kanan (Main Wrapper) */
...
<div class="wrapper">
    <nav class="sidebar">
        ...
        <ul class="nav nav-pills flex-column mb-auto mt-2">
            ...
            <?php if ($role == 'admin_gudang' || $role == 'administrator') : ?>
        ...
        <!--<div class="p-3">
             <a href="auth/logout.php" class="btn btn-outline-light btn-sm w-100 border-0 text-start opacity-50"><i class="fas fa-sign-out-alt me-2"></i> LOGOUT</a>
        </div>-->
    </nav>
    ...
    <main class="main-wrapper">
        <header class="topbar d-flex justify-content-between align-items-center">
            <div class="fw-bold text-uppercase" style="color: var(--mcp-blue);">
                <i class="fas fa-user-circle me-2"></i> Selamat Datang, <?php echo $nama; ?> 
                <span class="badge bg-light text-primary border ms-2 small" style="font-size: 0.6rem;"><?php echo strtoupper($role); ?></span>
            </div>
            
            <div class="small text-muted fw-bold d-flex align-items-center">
                <i class="far fa-calendar-alt me-2"></i> <?php echo date('d F Y'); ?>
                <a href="auth/logout.php" class="btn btn-danger btn-sm fw-bold ms-3"><i class="fas fa-sign-out-alt me-1"></i> KELUAR</a>
            </div>
        </header>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card border-start border-danger border-4 shadow-sm h-100">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <div class="text-xs font-weight-bold text-danger text-uppercase mb-1 small fw-bold">PR Belum Diproses</div>
                            ...
                            <table class="table table-hover align-middle m-0">
                                ...
                                <tbody>
                                    ...
                                    if(mysqli_num_rows($q) > 0) {
                                        ...
                                        echo "<tr><td colspan='4' class='text-center py-5 text-muted italic'>Tidak ada antrean saat ini</td></tr>";
                                    }
                                    ?>
                                </tbody>
                            </table>
            ...
            <?php if ($role == 'admin_gudang' || $role == 'administrator') : ?>
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <form action="" method="GET" class="bg-white p-2 rounded shadow-sm border d-flex align-items-center">
                        ...
                        <select name="tahun_filter" class="form-select form-select-sm border-0 fw-bold text-primary" onchange="this.form.submit()" style="width: 100px; outline: none;">
                            <?php
                            for($x = date('Y')+1; $x >= 2024; $x--){
